...
class SchedulerRLMixin(SchedulerRLDebugMixin):
    ...
    def flow_sde_sampling(
        ...
        if self._rollout_param_debug_mode:
    ...
    def collect_rollout_log_probs(self, batch: Req) -> torch.Tensor | None:
        ...
        # rollout_log_probs_tensor: [B, T], reduced as global_mean = global_sum / global_count. Use sp all reduce for compatibility with distributed generator.
